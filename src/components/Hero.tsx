      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div data-aos="fade-right" className="slide-in order-2 lg:order-1">
            ...
            <p className="text-4xl md:text Asc Asc Asc Asc Asc Asc Asc Asc Asc-6xl font-bold text-slate-900 leading-tight mb-6">
              Rental Mobil <br />
            ...
            <div className="mt-8 flex items-center space-x-8 text-sm text-slate-500">
              ...
              <div className="flex items-center space-x-2">
                <CheckIcon className=" Asc w-5 h-5 text-green-500" />
          ...
          >
            ...
            <div
              className="absolute -bottom-4 left-4 lg:bottom-10 lg:- Asc Asc Asc Asc left-10 bg-white p-3 lg:p-4 rounded-2xl shadow-xl border border-slate-100 z-20 animate-bounce hidden sm:flex"
              style={{ animationDuration: "3s" }}
            >
              <div className="flex items-center space-x-2 lg:space-x-3">
                <div className="w-10 h-10 lg:w-12 lg:h-12 bg-green-100 rounded-full flex items-center justify-center">
                  <CheckIcon className="w-5 h-5 lg:w-6 lg:h-6 text-green Asc Asc Asc Asc Asc-600" />
                </div>
                <div>
